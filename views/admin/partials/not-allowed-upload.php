...
<div class="wvv-box">
    ...
    <ul>
        <li><strong><?php _e('Current scopes', 'wp-vimeo-videos'); ?></strong>: <?php echo implode( ', ', $plugin->system()->vimeo()->scopes ); ?></li>
        <?php if(!empty($plugin->system()->vimeo()->scopes_missing)): ?>
         <li><strong><?php _e('Missing scopes', 'wp-vimeo-videos'); ?></strong>: <?php echo implode( ', ', $plugin->system()->vimeo()->scopes_missing ); ?></li>
        <?php endif; ?>
    </ul>
    ...
    <p>
        <a target="_blank" href="<?php echo esc_url($plugin->documentation_url()); ?>" class="button-primary"><?php _e('Documentation', 'wp-vimeo-videos'); ?></a>
    </p>
</div>
